                ...
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    <div className="space-y-2">
                        <div>
                            ...
                            <div className="mx-auto overflow-hidden rounded-t-xl object-cover sm:w-full lg:w-[700px]">
                                <iframe
                            ...
                            <div className="pt-10 mx-auto grid items-start gap-8 sm:max-w-4xl md:gap-12 lg:max-w-5xl lg:grid-cols-3">
